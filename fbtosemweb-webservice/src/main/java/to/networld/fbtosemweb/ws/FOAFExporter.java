 ...
 */
public class FOAFExporter extends HttpServlet {
	private static final long serialVersionUID = -3661916073684192857L;
	...
	public void doGet(HttpServletRequest _request, HttpServletResponse _response) throws ServletException, IOException {
		...
		try {
			...
			_response.setHeader("Content-Disposition", "attachment; filename=foaf.rdf");
			out.println(foafFile);
